...
Sub Test_clsCmCharacterType_whatType
    ...
    d = Array( _
        ...
        , new_DicOf(Array("No", "5-2", "Char", "ﬂ", "Expected", 2^4)) _
        , new_DicOf(Array("No", "6-1", "Char", "°", "Expected", 2^5)) _
        , new_DicOf(Array("No", "6-2", "Char", "∞", "Expected", 2^5)) _
        , new_DicOf(Array("No", "7-1", "Char", "Çl", "Expected", 2^6)) _
        , new_DicOf(Array("No", "7-2", "Char", "Çy", "Expected", 2^6)) _
        , new_DicOf(Array("No", "8-1", "Char", "ÇÅ", "Expected", 2^7)) _
        , new_DicOf(Array("No", "8-2", "Char", "Çí", "Expected", 2^7)) _
        , new_DicOf(Array("No", "9-1", "Char", "ÇV", "Expected", 2^8)) _
        , new_DicOf(Array("No", "9-2", "Char", "ÇX", "Expected", 2^8)) _
        , new_DicOf(Array("No", "10-1", "Char", "Å~", "Expected", 2^9)) _
        , new_DicOf(Array("No", "10-2", "Char", "ÅÄ", "Expected", 2^9)) _
        , new_DicOf(Array("No", "11-1", "Char", "Ç«", "Expected", 2^10)) _
        , new_DicOf(Array("No", "11-2", "Char", "ÇÔ", "Expected", 2^10)) _
        , new_DicOf(Array("No", "12-1", "Char", "É~", "Expected", 2^11)) _
        , new_DicOf(Array("No", "12-2", "Char", "ÉÄ", "Expected", 2^11)) _
        , new_DicOf(Array("No", "13-1", "Char", "Éü", "Expected", 2^12)) _
        , new_DicOf(Array("No", "13-2", "Char", "Ñ`", "Expected", 2^12)) _
        , new_DicOf(Array("No", "14-1", "Char", "É÷", "Expected", 2^13)) _
        , new_DicOf(Array("No", "14-2", "Char", "Ñp", "Expected", 2^13)) _
        , new_DicOf(Array("No", "15-1", "Char", "Ñü", "Expected", 2^14)) _
        , new_DicOf(Array("No", "15-2", "Char", "Ñæ", "Expected", 2^14)) _
        , new_DicOf(Array("No", "16-1", "Char", "ì~", "Expected", 2^15)) _
        , new_DicOf(Array("No", "16-2", "Char", "ìÄ", "Expected", 2^15)) _
        , new_DicOf(Array("No", "17-1", "Char", "Ë~", "Expected", 2^16)) _
        , new_DicOf(Array("No", "17-2", "Char", "ËÄ", "Expected", 2^16)) _
        )
