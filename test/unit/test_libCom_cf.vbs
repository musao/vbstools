...
Sub Test_cf_lenB
    ...
    data = Array ( _
            ...
            , new_DicOf(Array("Case", caseName & "1-2-2"  , "target", "Ç†"    , "expect", 2 )) _
            , new_DicOf(Array("Case", caseName & "1-3-1"  , "target", "aa"    , "expect", 2 )) _
            , new_DicOf(Array("Case", caseName & "1-3-2-1", "target", "aÇ†"   , "expect", 3 )) _
            , new_DicOf(Array("Case", caseName & "1-3-2-2", "target", "Ç†a"   , "expect", 3 )) _
            , new_DicOf(Array("Case", caseName & "1-3-3"  , "target", "Ç†Ç†"   , "expect", 4 )) _
            )
